package trashPandas.config.core;

import static trashPandas.config.core.util.Opmode.*;
...
import trashPandas.config.core.util.Opmode;
import trashPandas.config.pedro.constants.FConstants;
import trashPandas.config.pedro.constants.LConstants;
//import trashPandas.config.subsystems.Extend;
//import trashPandas.config.subsystems.Intake;
import trashPandas.config.subsystems.Lift;
//import trashPandas.config.subsystems.Light;
//import trashPandas.config.subsystems.Outtake;
//import trashPandas.config.vision.limelight.old.OldVision;
